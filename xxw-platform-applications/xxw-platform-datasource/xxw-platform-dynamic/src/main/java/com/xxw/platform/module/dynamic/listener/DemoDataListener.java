package com.xxw.platform.module.dynamic.listener;
...
// 有个很重要的点 DemoDataDTOListener 不能被spring管理，要每次读取excel都要new,然后里面用到spring可以构造方法传进去
@Slf4j
public class DemoDataListener implements ReadListener<DemoDataDTO> {
     ...
     * 缓存的数据
     */
    private List<DemoDataDTO> cachedDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);
     ...
     */
    @Override
    public void invoke(DemoDataDTO data, AnalysisContext context) {
...
//        }
    ...
    private void saveData() {
        ...
        try {
            ...
            for (DemoDataDTO l : cachedDataList) {
